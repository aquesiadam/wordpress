<?php		
	...
	if( class_exists( 'WTE_Fixed_Starting_Dates' ) )
	{
        ...
        if(isset($WTE_Fixed_Starting_Dates_setting) && $WTE_Fixed_Starting_Dates_setting!='' && isset($WTE_Fixed_Starting_Dates_setting['departure_dates']['edate']) && $WTE_Fixed_Starting_Dates_setting['departure_dates']['edate'] !='')
		{ 

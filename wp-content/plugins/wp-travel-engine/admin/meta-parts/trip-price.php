...
<div class="sale-price">
    ...
    <label for="wp_travel_engine_setting[sale]" class="checkbox-label"></label>
</div>
...
<div class="trip-duration">
    ...
    <?php echo do_action('wp_travel_engine_variable_pricing'); ?>
    <?php echo do_action('add_extra_services_trips'); ?>
</div>

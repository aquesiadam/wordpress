...
function wp_travel_engine_license_page() {
	...
	?>
	<div class="wrap">
		<h1 class="wp-heading-inline"><?php echo 'Plugin License Options'; ?></h1>
					...
					foreach ($addon_name as $key => $value) {
						...
						<tr valign="top">
							...
							<td>
								...
								<label class="description" for="wp_travel_engine_license[<?php echo $value;?>_license_key]"><?php echo 'Enter your license key for '; echo $key; ?></label>
							</td>
						</tr>
							...
							<tr valign="top">
								...
								<td>
									<?php if( $wte_fixed_departure_status == 'valid' ) { ?>
										<span class="active-msg" style="color:green;"><?php echo 'You license key has been activated.'; ?></span>
										<?php wp_nonce_field( 'wp_travel_engine_license_nonce', 'wp_travel_engine_license_nonce' ); ?>
										<input type="submit" class="button-secondary deactivate-license" data-id="<?php echo $value; ?>" name="edd_license_deactivate" value="<?php echo 'Deactivate License'; ?>"/>
									<?php } else { ?>
										<span class="active-msg" style="color:red;"><?php echo 'Please activate your license.'; ?></span>
										<?php wp_nonce_field( 'wp_travel_engine_license_nonce', 'wp_travel_engine_license_nonce' ); ?>
										<input type="submit" class="button-secondary activate-license" data-id="<?php echo $value; ?>" name="edd_license_activate" value="<?php echo 'Activate License'; ?>"/>
									<?php } ?>
								</td>
							</tr>
						<?php
